...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql=" INSERT INTO `pc`(`marque`, `sn`, `adresse_ip`, `adresse_mac`, `imprimante`, `duree_amortissement`) VALUES  ('$marque','$sn','$adresse_ip','$adresse_mac','$imprimante','$duree_amortissement');";
    $res=$db->exec($sql);
    if($res){
