...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql="UPDATE `pc` SET `marque`='$marque',`sn`='$sn',`adresse_ip`='$adresse_ip',`adresse_mac`='$adresse_mac',`imprimante`='$imprimante',`duree_amortissement`='$duree_amortissement' WHERE `id_pc` =$id_pc;";
    $res=$db->exec($sql);
    if($res){
